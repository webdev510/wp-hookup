                    ...
                    <div class="card-body">
                        ...
                        <div class="sub-section">
                            <div class="block-with-tooltip  conditions-block">
                                <p><?php _e('Set up condition', 'mpg'); ?></p>
                        ...
                        <div class="sub-section filters">
                            ...
                            <div class="block-with-tooltip ">
                                ...
                                <div class="tooltip-circle" data-tippy-content="<?php _e('Use this to set up column header for sorting by (optional)', 'mpg'); ?>"><i class="fa fa-question"></i></div>
                            </div>
                            ...
                            <div class="block-with-tooltip">
                                ...
                                <div class="tooltip-circle" data-tippy-content="<?php _e('Use this to set up column header for sorting by', 'mpg'); ?>"><i class="fa fa-question"></i></div>
                            </div>
                            ...
                            <div class="block-with-tooltip ">
                                ...
                                <div class="tooltip-circle" data-tippy-content="<?php _e('Use this to set up limit of rows that shortcode will display', 'mpg'); ?>"><i class="fa fa-question"></i></div>
                            </div>
